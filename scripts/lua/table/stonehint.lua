...
--------------------------罂粟花开“金木水火土”石头------------------------
---- great gems
function ItemHint_GGR ( Lv )                      ---Great Gem of Rage
	local eff = Lv * 6
	local Hint = "Gem Bonus Strength +"..eff
	return Hint
end
function ItemHint_GGS ( Lv )                             ---Great Gem of Soul
local eff = Lv * 6
	local Hint = "Gem Bonus Spirit +"..eff
	return Hint
end
function ItemHint_GGOS ( Lv )                     ---Great Gem of Striking
	local eff = Lv * 6
	local Hint = "Added Accuracy +"..eff
	return Hint
end
function ItemHint_GGC  ( Lv )                     ---Great Gem of Colossus
	local eff = Lv * 6
	local Hint = "Gem Bonus Constitution +"..eff
	return Hint
end
function ItemHint_GGW   ( Lv )                      ---Great Gem of Wind
	local eff = Lv * 6
	local Hint = "Gem Bonus Agility +"..eff
	return Hint
end
